...
correct_dist_matrix_hamming=function(dist_mat, replace="auto" ){
	...
	if(any(dist_mat==Inf)){
		print(paste("Infinite detected in dist matrix (hamming?), will crash the hclust, replacing by",replace))
